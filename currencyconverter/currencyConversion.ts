...
export function Currrency_Conversion(currency:currency){

    // finding the index of current currency
    let currCurrency_Index:number = currencylist.findIndex(list=> list.currency_code === currency.currentcurrency)
    ...
    let convCurrency_Index:number = currencylist.findIndex(list=> list.currency_code === currency.conversioncurrency)
